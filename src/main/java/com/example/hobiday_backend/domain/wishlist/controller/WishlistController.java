...
public class WishlistController {
    ...
    // 위시 등록
    @Operation(summary="위시 등록", description="사용자와 공연ID(PF255667) 매칭시켜 위시 등록 | 중복 등록시 예외 적용함")
    ...
    @Operation(summary="위시 해제", description="사용자와 공연ID(PF255667) 매칭시켜 위시 해제 | 중복 삭제시 예외 적용함")
